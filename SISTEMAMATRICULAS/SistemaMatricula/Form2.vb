...
Public Class frmGrafica
    Private Sub frmGrafica_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim conexion As New OleDbConnection("Provider=Microsoft.Jet.Oledb.4.0; Data Source=F:\sisteMASMATRICULA\SistemaMatricula\base de datos\matricula (2002-2003).mdb")
        Try
            conexion.Open()
            MsgBox("Conectado")
